...
static void concurrent_add_record() {
    ZoneStore store;
    ...
    CHK(store.recordCount() == static_cast<std::size_t>(kThreadCount * kRecordsPerThread));
}

// Executes all zonestore-concurrent-access test cases.
static void run_tests() {
    RUN(concurrent_add_record);
}
